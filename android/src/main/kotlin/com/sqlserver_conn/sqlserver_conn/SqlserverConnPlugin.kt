package com.sqlserver_conn.sqlserver_conn
...
class SqlserverConnPlugin : FlutterPlugin, MethodCallHandler {
    ...
    val TAG: String = "SqlserverConnPlugin"

    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        context = flutterPluginBinding.applicationContext
        channel =
            MethodChannel(flutterPluginBinding.binaryMessenger, "com.sqlserver_conn.sqlserver_conn")
